        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-danger mb-0">
                    <i class="fas fa-exclamation-triangle mr-2"></i> Data kategori tidak ditemukan.
                </div>
            </div>
    ...
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header"
                ...
                <h5 class="modal-title text-white font-weight-bold">Detail Kategori</h5>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                            ...
                            <div class="user-info-card">
                                ...
                                <div class="user-info-item">
                                    ...
                                    <div class="info-value">
                                        {{ $kategori->created_at ? $kategori->created_at->format('d M Y H:i') : 'N/A' }}
                                    </div>
                                </div>
                                <div class="user-info-item">
                                    <div class="info-label">
                                    ...
                                    <div class="info-value">
                                        {{ $kategori->updated_at ? $kategori->updated_at->format('d M Y H:i') : 'N/A' }}
                                    </div>
                                </div>
                            </div>
                        </div>
