...
class LevelDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            return '
            <div class="d-flex">
                <a href="' . route('level.edit', $row->level_id) . '" class="btn btn-sm btn-primary d-flex align-items-center" style="margin-right: 5px; height: 100%;">
                <i class="fas fa-edit"></i> Edit
                </a>
                <form action="' . route('level.destroy', $row->level_id) . '" method="POST">
                ' . csrf_field() . '
                ' . method_field('DELETE') . '
