...
class Penjualan_DetailDataTable extends DataTable
{
    /**
     ...
     */
    public function query(Penjualan_DetailModel $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('penjualandetail-table')
    ...
    {
        return [
            Column::make('penjualan_detail_id'),
    ...
    {
        return 'PenjualanDetail_' . date('YmdHis');
    }
}
