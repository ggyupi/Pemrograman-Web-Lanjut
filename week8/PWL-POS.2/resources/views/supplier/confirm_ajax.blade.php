    ...
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="{{ url('/supplier') }}" class="btn btn-back btn-outline-secondary">
                ...
                <div class="modal-body p-4">
                    <div class="alert alert-warning animate__animated animate__fadeIn">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="mb-0">Apakah Anda yakin ingin menghapus data supplier berikut?</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="user-detail-container mt-4 animate__animated animate__fadeIn">
                        ...
                        <div class="mt-3 alert alert-danger">
                            <i class="fas fa-exclamation-circle mr-2"></i> Menghapus supplier ini mungkin akan mempengaruhi data pengguna yang terkait.
                        </div>
                    </div>
                </div>
