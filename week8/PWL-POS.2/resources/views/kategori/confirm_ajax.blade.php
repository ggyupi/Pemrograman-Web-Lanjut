    ...
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="{{ url('/kategori') }}" class="btn btn-back btn-outline-secondary">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="user-detail-container mt-4 animate__animated animate__fadeIn">
                        ...
                        <div class="mt-3 alert alert-danger">
                            <i class="fas fa-exclamation-circle mr-2"></i> Menghapus kategori ini mungkin akan mempengaruhi data pengguna yang terkait.
                        </div>
                    </div>
                </div>
